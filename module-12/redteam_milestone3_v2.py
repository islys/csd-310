...
def wine_sales_report():
    ...
    print("--------------------------------------------------")
    print("{:<20}  {:<20}  {:<20}".format("Wine Type", "Distributor", "Total Sold"))
    print("-" * 60)
...
def employee_work_hours_report():
    ...
    print("{:<25}  {:<10}  {:<10}  {:<10}  {:<10}  {:<20}".format("Employee", "Q1", "Q2", "Q3", "Q4", "Total Hours Worked"))
    print("-" * 80)
    
    for row in result:
        employee_name, q1, q2, q3, q4, total_hours = row
        print("{:<25}  {:<10}  {:<10}  {:<10}  {:<10}  {:<20}".format(employee_name, q1, q2, q3, q4, total_hours))
